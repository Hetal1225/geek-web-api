...
const setDesignation =(async (req, res) => {
    ...
    if(user){
        ...
        const newdesignation = await profileModal.findByIdAndUpdate(req.params.id,{
...
module.exports = { setUser,getUser,getUserById,putUsers,deleteUsers,getAllUsers,setBankDetails,setDesignation};
